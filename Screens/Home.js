...
export default function Home({ navigation }) {
  ...
  if (Loading)
    return (<View style={styles.container}><LoadingComponent /></View>)
    ...
    if (fontsLoaded) {
      return (
        ...
        <View style={styles.container}>
          ...
          <Image source={backImage2} style={styles.backgroundImage2} fadeDuration={100} />
          <Image source={backImage1} style={styles.backgroundImage1} fadeDuration={100} />
          <ScrollView>

            <Text style={{ fontFamily: 'Raleway', fontSize: 22, color: '#CFCFCF', paddingLeft: 20 }}>World</Text>
