        ...
        return (
            <View style={{ flex: 1, flexDirection: 'row', padding: 7 }}>
                ...
                <View style={{ flex: 1,paddingTop:30}}>
                    <Image source={imageLink} resizeMode='contain' fadeDuration={100} style={{ justifyContent: 'center', alignItems: 'center', width: 80, height: 80 }} />
                </View>
                <View style={{ flex: 3, flexDirection: 'column' }}>
                    <Text style={{ fontFamily: 'Raleway', fontSize: 22, color: '#ababab', padding: 7 }}>{heading}</Text>
                    <Text style={{ fontFamily: 'Raleway', fontSize: 14, color: '#969595' }}>{text}</Text>
                </View>
        ...
        return (
            <View style={styles.container}>
                <View style={styles.header}>
                    <Text style={{ fontFami: 'Raleway', fontSize: 25, color: '#CFCFCF', paddingLeft: 10 }}>Health Care</Text>
                </View>
                <View style={styles.body}>
                    <ScrollView>
                        <Instructions imageLink={cough} heading='Symptoms ' text='Common symptoms of COVID-19 include fever, dry cough, fatigue, loss of appetite, loss of smell, and body ache. In some people, COVID-19 causes more severe symptoms like high fever, severe cough, and shortness of breath, which often indicates pneumonia.
