    ...
    const DetailedView = () => {
        return (
            <View style={{ flex: 1, flexDirection: 'row', paddingTop: 15 }}>
                ...
                <Animated.View style={{ flex: 1, alignItems: 'flex-end',opacity: animatedOpacity }}>
        ...
        <View style={{ flex: 1, marginTop: 30 }}>
            <View style={{ flex: 1, height: 120, flexDirection: 'row', }}>
                ...
                <View style={{ flex: 1, flexDirection: 'column', alignItems: 'flex-end' }}>
                    <View style={{ width: 12, height: 12, margin: 8, backgroundColor: 'rgb(0,50,133)' }} />
                    <View style={{ width: 12, height: 12, margin: 8, backgroundColor: 'rgba(5,142,85,1)' }} />
                    <View style={{ width: 12, height: 12, margin: 8, backgroundColor: 'rgba(183,149,72,1)' }} />
                    <View style={{ width: 12, height: 12, margin: 8, backgroundColor: 'rgba(155,5,40,1)' }} />
                </View>
            ...
            <View style={{ flex: 1 }}>
                <TouchableWithoutFeedback
                    onPress={animateView}>
                    <View style={{ flex: 1, justifyContent: 'flex-end', flexDirection: 'row', paddingRight: 10, marginBottom: 5 }}>
                        <Text style={{ fontFamily: 'Raleway', color: '#757E88' }}>Details  </Text>
                ...
                {/* Updated Deatils  */}
                <View style={{ flex: 1, height: 30, justifyContent: 'center', alignItems: 'center', margin: 10 }}>
                    <Text style={{ fontFamily: 'Raleway', fontSize: 12, color: '#757E88' }}>Last Updated  {date_time}</Text>
                </View>
            </View>
        </View>
    )
