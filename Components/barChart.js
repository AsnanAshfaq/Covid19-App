...
export default function Chart({ worldData }) {
    ...
    const data1 = [worldData.cases]
        .map((value) => ({ value }))
    const data2 = [worldData.recovered]
        .map((value) => ({ value }))
    const data3 = [worldData.critical]
        .map((value) => ({ value }))
    const data4 = [worldData.deaths]
        .map((value) => ({ value }))
    const barData = [
        {
    ...
    return (
        ...
        <Animated.View style={{ flex: 1, marginTop: 20, justifyContent: 'center', alignItems: 'center', flexDirection: 'row',opacity: animatedOpacity }}>
                ...
                <View style={{ borderLeftWidth: 2, borderLeftColor: '#CFCFCF', borderBottomWidth: 2, borderBottomColor: '#CFCFCF' }}>
                    <BarChart
